...
export default function ProductCard({product}) {
  ...
  return (
   <div
              ...
              className="group flex flex-col bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-850/70 rounded-2xl overflow-hidden hover:border-zinc-300 dark:hover:border-zinc-800 shadow-sm hover:shadow-md transition-all duration-300 relative"
            >
              ...
              <div className="p-4 flex-1 flex flex-col justify-between text-left">
                ...
                <div className="mt-4 pt-3 border-t border-zinc-100 dark:border-zinc-850/60 flex items-center justify-between">
                  <span className="text-base font-black text-zinc-900 dark:text-white">
                    ${product.price.toLocaleString()}
                  </span>

                  <div className="flex gap-1">
                    <span className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/40 dark:border-zinc-850/40 px-2 py-0.5 rounded-md">
                      {product.category}
                    </span>
                    <span className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/40 dark:border-zinc-850/40 px-2 py-0.5 rounded-md">
                      📍 {product.location}
